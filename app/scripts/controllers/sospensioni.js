  ...
  mod.controller('SospensioniCtrl', [
    ...
    function(
      ...
      function sospensioniMngr(data) {
        ...
        res.prototype.getMotiviSospensione = function() { 
        ...
        res.prototype.getSospensione = function() {
          ...
          sosp.cod_tipo_sospensione     = this.edit.cod_tipo_sospensione;
      ...
      var aggiornaSospensione = function() {
        ...
        $http.post(ulr, $scope.tipo_sospensione.getSospensione())
          .success(function(data, status, headers, config) {
            init();
          })
          .error(function(data, status, headers, config) {
